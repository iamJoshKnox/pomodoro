...
4. The whys are merged into a single Why box. Tidy it and **What I tried:**, then press **Ask Joel** or **Ask Eric**. That copies a message ready to paste into Teams, with all the whys and all the notes each joined into one line:
